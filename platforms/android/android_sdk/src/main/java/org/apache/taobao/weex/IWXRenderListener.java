...
public interface IWXRenderListener {
  ...
  /**
   * If {@link org.apache.weex.common.WXRenderStrategy#APPEND_ASYNC} is applied, this method
   * will be invoked when the rendering of first view is finish.
   * If {@link org.apache.weex.common.WXRenderStrategy#APPEND_ONCE} is applied, this method will
